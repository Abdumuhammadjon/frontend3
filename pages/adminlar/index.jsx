...
export default function Dashboard() {
  ...
  <div className="bg-white shadow-md h-18 sm:h-24 flex items-center px-4 sm:px-6 fixed w-full z-10 top-0">
  <h1 className="text-xl sm:text-xl font-bold text-gray-800">Dashboard</h1>
</div>
