...
const GroupedQuestions = ({ subjectId }) => {
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-100">
      {/* Navbar */}
      <div className="bg-white shadow-md h-16 flex items-center fixed top-0 left-0 right-0 z-50 px-6">
          ...
          <div className="flex items-center gap-4">
            {isLoggedIn && (
              <button
                ...
                className="bg-red-500 hover:bg-red-600 text-white px-3 py-1.5 rounded-lg shadow transition text-sm"
              >
